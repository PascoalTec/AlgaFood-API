...
insert into restaurante (taxa_frete, cozinha_id, id, nome) values (10, 1, 1,'Thai Gourmet');
insert into restaurante (taxa_frete, cozinha_id, id, nome) values (9.50, 1, 1, 'Thai Delivery');
insert into restaurante (taxa_frete, cozinha_id, id, nome) values (3, 2, 2, 'Tuk Tuk Comida Indiana');
